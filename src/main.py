...
channels_to_personnages = {
    ...
    "archibald_obscurus": Personnage("Monsieur Archibald Obscurus", "fantôme, boulanger", "Il prétendait être dans sa cuisine en train de préparer la soirée d'Halloween, vérifiable par des notes et des préparatifs retrouvés.", True, False, "assets/fantome.png", "Un érudit calme et énigmatique, obsédé par l'étude des phénomènes surnaturels. Il parle rarement de lui-même, préférant discuter de sujets ésotériques avec ceux qui peuvent le suivre dans ses intérêts."),
    "scarlett_sombreval": Personnage("Mademoiselle Scarlett Sombreval", "sorcière, infirmière", "Elle prétendait être dans le Jardin des  mes Perdues, prenant l'air entre les préparatifs de la fête. Certains invités peuvent confirmer avoir vu une silhouette féminine dans l'obscurité.", True, False, "assets/sorcière.png", "Une actrice théâtrale charismatique avec une passion pour le macabre. Elle est extravertie, aime être au centre de l'attention et a une collection de souvenirs de films d'horreur dans sa chambre."),
    "orion_sangfroid": Personnage("Orion Sangfroid", "diable, fleuriste", "il affirmait être dans le Salon des Ombres Éternelles, admirant la collection d'armes. Des invités ont peut-être croisé son chemin pendant cette période.", True, False, "assets/diable.png", "Un homme stoïque avec une fascination pour les fleurs. Il parle peu de ses propres expériences, mais son regard intense suggère une vie pleine de mystères."),
    "casyope_lycanthrope": Personnage("Casyope Lycanthrope", "loup-garou maire fan de science", "Il prétendait être dans son Laboratoire Interdit, travaillant sur des expériences. Des résidus ou des indices de son travail pourraient être trouvés dans le laboratoire.", True, False, "assets/loup.png", "Un maire et scientifique déterminé et curieux, passionné par l'étude des créatures surnaturelles. Il est pragmatique et sceptique, mais toujours ouvert à la découverte de nouvelles vérités."),
    "edgar_frisson": Personnage("Monsieur Edgar Frisson", "zombie, facteur", " Il prétendait être dans la salle à manger, supervisant les préparatifs du dîner. Des témoignages d'autres membres du personnel pourraient confirmer ou réfuter cette affirmation.", True, False, "assets/zombie.png", "Il est discret, mais il semble avoir un sixième sens pour les mystères. Sa présence discrète cache peut-être plus qu'il ne le laisse paraître.")
}
